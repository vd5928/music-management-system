    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="MovieVTU.php">Movies</a></li>
                <li><a href="TrendingVTU.php">Trending</a></li>
                <li><a href="PlaylistVTU.php">Playlist</a></li>
                <li><a href="Subscription.php">Playlist</a></li>
                ...
                <div class="modal-body">
                        ...
                        While($row=mysqli_fetch_array($recod))
                        {
                            //assigning fetched data
                                         ...
                                         echo "<td>".$row['singerID']."</td>";
                                         echo "<td>".$row['movieID']."</td>";
                                         echo "<td>".$row['lyricist']."</td>";
                                         echo "<td>".$row['musicDistributer']."</td>";
                                         echo "<td>".$row['musicProducer']."</td>";
