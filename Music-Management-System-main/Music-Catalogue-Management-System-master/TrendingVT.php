...
<head>
    ...
    <title>Trending-ViewTable</title>
...
<div class="modal-dialog modal-login modal-lg cen">
            <div class="modal-content modal-lg big">
                ...
                <div class="modal-body">
                        ...
                        //To get sigle value
                        $sql="(Select t.*,s.songName from trending t,songs s where t.songID=s.songID OR t.songID=NULL order by slno);";
                        ...
                        While($row=mysqli_fetch_array($recod))
                        {
                            //assigning fetched data
                                         ...
                                         echo "<tr><form action=UDPTrending.php method=post>";
                                         echo "<td><input size=10 type=text name=slno value='".$row['slno']."' readonly></td>";
